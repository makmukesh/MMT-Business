...
public class Bill_Failed_Activity extends AppCompatActivity {

    private static final String TAG = "Bill_Failed_Activity";
...
//    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bill_failed);
