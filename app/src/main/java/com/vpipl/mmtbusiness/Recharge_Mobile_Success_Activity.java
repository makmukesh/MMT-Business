...
public class Recharge_Mobile_Success_Activity extends AppCompatActivity {

    private static final String TAG = "Recharge_Mobile_Success_Activity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recharge_mobile_success);
