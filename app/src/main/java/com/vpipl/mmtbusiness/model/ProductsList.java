...
public class ProductsList {
    ...
    List<SubProductsList> subProductList;
    ...
    private String ShoppingWalletPer = "";
    private Bitmap Imagebitmap = null;

    public String getShoppingWalletPer() {
        return ShoppingWalletPer;
    }

    public void setShoppingWalletPer(String ShoppingWalletPer) {
        this.ShoppingWalletPer = ShoppingWalletPer;
    }
