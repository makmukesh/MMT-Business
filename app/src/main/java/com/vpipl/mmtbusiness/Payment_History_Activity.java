...
public class Payment_History_Activity extends AppCompatActivity {
    ...
    String TAG = "Level_Commission_detail_Activity";
        ...
        img_login_logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!AppController.getSpIsLogin().getBoolean(SPUtils.IS_LOGIN, false))
                    startActivity(new Intent(Payment_History_Activity.this, Login_Activity.class));
                else
                    AppUtils.showDialogSignOut(Payment_History_Activity.this);
            }
        });
    ...
    private void executePackageRequest()
    {
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... params) {
                ...
                response = AppUtils.callWebServiceWithMultiParam(Payment_History_Activity.this, postParameters, QueryUtils.methodToGet_MonthSession, TAG);
                return response;
            }
    ...
    private void showPackageDialog() {
        try {
            ...
            e.printStackTrace();
            AppUtils.showExceptionDialog(Payment_History_Activity.this);
        }
    }
    ...
    private void executeLevelCommissionRequest(final List postparameters) {
        try {
            if (AppUtils.isNetworkAvailable(Payment_History_Activity.this)) {
                new AsyncTask<Void, Void, String>() {
                    protected void onPreExecute() {
                        AppUtils.showProgressDialog(Payment_History_Activity.this);
                    }
                    ...
                    protected String doInBackground(Void... params) {
                        ...
                        try {
                            ...
                            response = AppUtils.callWebServiceWithMultiParam(Payment_History_Activity.this, postparameters, QueryUtils.methodToGet_PaymentHistory, TAG);
                    ...
                    protected void onPostExecute(String resultData) {
                        ...
                        try {
                            ...
                            if (jsonObject.getString("Status").equalsIgnoreCase("True"))
                            {
                                ...
                                AppUtils.alertDialog(Payment_History_Activity.this, jsonObject.getString("Message"));
                            }
                        } catch (Exception e) {
                            e.printStackTrace();
                            AppUtils.showExceptionDialog(Payment_History_Activity.this);
    ...
    public void WriteValues(JSONArray jsonArrayData) {
        ...
        try {
            ...
            if (jsonArrayData.length() > 0)
            {
                ...
                C1.setText("Payout Date");
                D1.setText("Designation");
                E1.setText("Level Earning");
                F1.setText("Total Earning");
                L1.setText("TDS Amount");
                H1.setText("Processing Charges");
                K1.setText("Total Deductions");
                M1.setText("Net Payble");
                N1.setText("Payment Slip");
                ...
                for (int i = 0; i < jsonArrayData.length(); i++) {
                    try {
                        ...
                        String PayoutNo = jobject.getString("SessId");
                        String PayoutDate = (jobject.getString("Session"));
                        String Designation = jobject.getString("Designation");
                        String LevelEarning = jobject.getString("CommissionAmt");
                        String TDSAmount = jobject.getString("TDSAmount");
                        String ProcessingCharges = jobject.getString("AdminCharge");
                        String TotalDeductions = jobject.getString("TotalDeduction");
                        String NetPayble = jobject.getString("NetIncome");
                        String TotalEarning = jobject.getString("CommissionAmt");
                        ...
                        A.setText("" + (i + 1));
                        B.setText(PayoutNo);
                        C.setText(PayoutDate);
                        D.setText(Designation);
                        E.setText(LevelEarning);
                        F.setText(TotalEarning);
                        L.setText(TDSAmount);
                        H.setText(ProcessingCharges);
                        K.setText(TotalDeductions);
                        M.setText(NetPayble);
                        ...
                        N.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                executeGetEncryptedID(N.getTag().toString());
                            }
                        });
    ...
    private void executeGetEncryptedID(final String payoutno) 
    {
        try {
            if (AppUtils.isNetworkAvailable(Payment_History_Activity.this)) {
                new AsyncTask<Void, Void, String>() {
                    ...
                    protected String doInBackground(Void... params) {
                        ...
                        try {
                            ...
                            response = AppUtils.callWebServiceWithMultiParam(Payment_History_Activity.this, postParameters, QueryUtils.methodEncryptData, TAG);
                        } catch (Exception e) {
                            e.printStackTrace();
                            AppUtils.showExceptionDialog(Payment_History_Activity.this);
                        }
                    ...
                    protected void onPostExecute(String resultData) {
                        ...
                        try {
                            ...
                            if (jsonObject.getString("Status").equalsIgnoreCase("True"))
                            {
                                executeGetEncryptedFormNo(payoutno, jsonObject.getString("Message"));
                            } else {
                                AppUtils.alertDialog(Payment_History_Activity.this, jsonObject.getString("Message"));
                            }
                        } catch (Exception e) {
    ...
    private void executeGetEncryptedFormNo(final String payoutno, final  String IDno) {
        try {
            if (AppUtils.isNetworkAvailable(Payment_History_Activity.this)) {
                new AsyncTask<Void, Void, String>() {
                    @Override
                    ...
                    protected void onPostExecute(String resultData) {
                        ...
                        try {
                            ...
                            if (jsonObject.getString("Status").equalsIgnoreCase("True"))
                            {
                                ...
                                startActivity(new Intent(Payment_History_Activity.this, Payment_Slip_Activity.class)
                                        .putExtra("URL",""+("http://realtimetrading.in/Dashboard/PaymentSlip.aspx?PNo="+jsonObject.getString("Message")+"&FNo="+IDno)));
