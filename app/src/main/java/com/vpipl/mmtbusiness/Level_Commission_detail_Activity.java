...
public class Level_Commission_detail_Activity extends AppCompatActivity {
        ...
        img_login_logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!AppController.getSpIsLogin().getBoolean(SPUtils.IS_LOGIN, false))
                    startActivity(new Intent(Level_Commission_detail_Activity.this, Login_Activity.class));
                else
                    AppUtils.showDialogSignOut(Level_Commission_detail_Activity.this);
            }
        });
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level_commission_detail);
    ...
    private void executePackageRequest()
    {
        new AsyncTask<Void, Void, String>() {
            ...
            protected void onPreExecute() {
                AppUtils.showProgressDialog(Level_Commission_detail_Activity.this);
            }
            ...
            protected String doInBackground(Void... params) {
                ...
                response = AppUtils.callWebServiceWithMultiParam(Level_Commission_detail_Activity.this, postParameters, QueryUtils.methodToGet_MonthSession, TAG);
                return response;
            }
    ...
    private void showPackageDialog() {
        try {
            ...
            e.printStackTrace();
            AppUtils.showExceptionDialog(Level_Commission_detail_Activity.this);
        }
    }
    ...
    private void executeLevelCommissionRequest(final List postparameters) {
        try {
            if (AppUtils.isNetworkAvailable(Level_Commission_detail_Activity.this)) {
                new AsyncTask<Void, Void, String>() {
                    protected void onPreExecute() {
                        AppUtils.showProgressDialog(Level_Commission_detail_Activity.this);
                    }
                    ...
                    protected String doInBackground(Void... params) {
                        ...
                        try {
                            ...
                            response = AppUtils.callWebServiceWithMultiParam(Level_Commission_detail_Activity.this, postparameters, QueryUtils.methodToGet_LevelCommissionDetailReport, TAG);
                    ...
                    protected void onPostExecute(String resultData) {
                        ...
                        try {
                            ...
                            if (jsonObject.getString("Status").equalsIgnoreCase("True"))
                            {
                                ...
                                AppUtils.alertDialog(Level_Commission_detail_Activity.this, jsonObject.getString("Message"));
                            }
                        } catch (Exception e) {
                            e.printStackTrace();
                            AppUtils.showExceptionDialog(Level_Commission_detail_Activity.this);
    ...
    public void WriteValues(JSONArray jsonArrayData)
    {
        ...
        try {
            ...
            if (jsonArrayData.length() > 0) {
                ...
                A1.setText("S No.");
                B1.setText("Session");
                C1.setText("Down Level No");
                D1.setText("ID No");
                E1.setText("Member Name");
                F1.setText("Kit Name");
                L1.setText("Investment Amount");
                H1.setText("Commission %");
                ...
                for (int i = 0; i < jsonArrayData.length(); i++) {
                    try {
                        ...
                        String DownLevelNo = (jobject.getString("LevelId"));
                        String IDNo = jobject.getString("IDNo");
                        String MemberName = WordUtils.capitalizeFully(jobject.getString("MemName"));
                        String InvestmentAmount = jobject.getString("InvestmentAmount");
                        String Commission = jobject.getString("CommissionPer");
                        ...
                        A.setText(""+(i+1));
                        B.setText(Session);
                        C.setText(DownLevelNo);
                        D.setText(IDNo);
                        E.setText(MemberName);
                        F.setText(KitName);
                        L.setText(InvestmentAmount);
                        H.setText(Commission);
