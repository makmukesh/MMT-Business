...
public class HorizentalSizeListViewFilter_Adapter extends BaseAdapter {
    Context context;
    LayoutInflater inflater = null;

    ArrayList<HashMap<String, String>> sizeList;

    public HorizentalSizeListViewFilter_Adapter(Context context, ArrayList<HashMap<String, String>> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        try {
            ...
            holder.txt_size.setText(sizeList.get(position).get("Size"));
        } catch (Exception e) {
            e.printStackTrace();
