...
public class HorizentalColorListView_Adapter extends BaseAdapter {
    Context context;
    LayoutInflater inflater = null;

    ArrayList<HashMap<String, String>> colorList;

    public HorizentalColorListView_Adapter(Context context, ArrayList<HashMap<String, String>> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        try {
            ...
            holder.img_color.setBackgroundColor(Color.parseColor(colorList.get(position).get("colorName")));
        } catch (Exception e) {
            e.printStackTrace();
