...
public class Direct_members_Activity extends AppCompatActivity {
        ...
        img_login_logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!AppController.getSpIsLogin().getBoolean(SPUtils.IS_LOGIN, false))
                    startActivity(new Intent(Direct_members_Activity.this, Login_Activity.class));
                else
        ...
        try {
            ...
            txt_from_joining.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    new DatePickerDialog(Direct_members_Activity.this, date, myCalendar.get(Calendar.YEAR), myCalendar.get(Calendar.MONTH), myCalendar.get(Calendar.DAY_OF_MONTH)).show();
                }
            });
            ...
            txt_heading.setText("My Direct Members");
            cb_activation_week.setVisibility(View.GONE);
    ...
    private void executePackageRequest() {
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... params) {
                ...
                response = AppUtils.callWebServiceWithMultiParam(Direct_members_Activity.this, postParameters, QueryUtils.methodSponsorPageFillPackage, TAG);
                return response;
            }
    ...
    private void executeMemberDownlineListRequest(final List postparameters) {
        try {
            if (AppUtils.isNetworkAvailable(Direct_members_Activity.this)) {
                new AsyncTask<Void, Void, String>() {
                    ...
                    protected String doInBackground(Void... params) {
                        ...
                        try {
                            ...
                            response = AppUtils.callWebServiceWithMultiParam(Direct_members_Activity.this, postparameters, QueryUtils.methodToGetMyDirectMembers, TAG);
                        ...
                        try {
                            ...
                            if (jsonObject.getString("Status").equalsIgnoreCase("True")) {
                                if (jsonObject.getString("Message").equalsIgnoreCase("Successfully.!")) {
                                    WriteValues(jsonArrayTotalRowCount.getJSONObject(0).getString("Total"), jsonArrayJoiningDetails, jsonArrayDownLineDetail);
    ...
    public void WriteValues(final String count, final JSONArray jarray, JSONArray jsonArrayDownLineDetail) {
        ...
        try {
            ...
            txt_left_paid_members.setText(jarray.getJSONObject(0).getString("LeftBv"));
            txt_right_paid_members.setText(jarray.getJSONObject(0).getString("RightBv"));
            txt_left_total_members.setText(jarray.getJSONObject(0).getString("LeftJoining"));
            txt_right_total_members.setText(jarray.getJSONObject(0).getString("RightJoining"));
            ...
            if (jsonArrayDownLineDetail.length() > 0) {
                ...
                String count_text = "(Showing " + jsonArrayDownLineDetail.length() + " of " + count + " records)";
...
//                        }
                        ...
                        ll.addView(row);
                        if (i < jsonArrayDownLineDetail.length() - 1)
                            ll.addView(view_one);
