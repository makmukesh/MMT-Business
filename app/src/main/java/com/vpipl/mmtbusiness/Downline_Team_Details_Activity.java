...
public class Downline_Team_Details_Activity extends AppCompatActivity {
        ...
        img_login_logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!AppController.getSpIsLogin().getBoolean(SPUtils.IS_LOGIN, false))
                    startActivity(new Intent(Downline_Team_Details_Activity.this, Login_Activity.class));
                else
        ...
        try {
            ...
            txt_from_joining.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    new DatePickerDialog(Downline_Team_Details_Activity.this, date, myCalendar.get(Calendar.YEAR), myCalendar.get(Calendar.MONTH), myCalendar.get(Calendar.DAY_OF_MONTH)).show();
                }
            });
    ...
    private void executePackageRequest() {
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... params) {
                ...
                response = AppUtils.callWebServiceWithMultiParam(Downline_Team_Details_Activity.this, postParameters, QueryUtils.methodSponsorPageFillPackage, TAG);
                return response;
            }
    ...
    private void executeWeekRequest() {
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... params) {
                String response = "";
                List<NameValuePair> postParameters = new ArrayList<>();
                response = AppUtils.callWebServiceWithMultiParam(Downline_Team_Details_Activity.this, postParameters, QueryUtils.methodSponsorActivationWeek, TAG);
                return response;
            }
    ...
    private void executeMemberDownlineListRequest(final List postparameters) {
        try {
            if (AppUtils.isNetworkAvailable(Downline_Team_Details_Activity.this)) {
                new AsyncTask<Void, Void, String>() {
                    ...
                    protected String doInBackground(Void... params) {
                        ...
                        try {
                            ...
                            response = AppUtils.callWebServiceWithMultiParam(Downline_Team_Details_Activity.this, postparameters, QueryUtils.methodToGetDownlineTeamDetail, TAG);
    ...
    public void WriteValues() {
        ...
        try {
            ...
            if (AllDataArray.length() > 0) {
                ...
                L1.setText("Upliner ID");
                J1.setText("Side");
                K1.setText("Activation\nPV");
                M1.setText("Package Name");
                ...
                for (int i = 0; i < length; i++) {
                    try {
                        ...
                        String SponserIdNo = jobject.getString("SponserIdNo");
...
//                        }
                        ...
                        H.setText(SponserIdNo);
                        J.setText(side);
                        K.setText(JoiningBV);
                        L.setText(ReferralIdNo);
                        M.setText(Package_name);
