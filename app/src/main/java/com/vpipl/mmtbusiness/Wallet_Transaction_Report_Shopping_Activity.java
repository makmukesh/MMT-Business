...
public class Wallet_Transaction_Report_Shopping_Activity extends AppCompatActivity {


    String TAG = "Wallet_Transaction_Report_Shopping_Activity";
    ...
    final DatePickerDialog.OnDateSetListener date = new DatePickerDialog.OnDateSetListener() {
        ...
        public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
            ...
            if (new Date().after(myCalendar.getTime())) {
                ...
                AppUtils.alertDialog(Wallet_Transaction_Report_Shopping_Activity.this, "Selected Date Can't be After today");
            }
        }
    };
    TextView txt_WB;
        ...
        img_login_logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!AppController.getSpIsLogin().getBoolean(SPUtils.IS_LOGIN, false))
                    startActivity(new Intent(Wallet_Transaction_Report_Shopping_Activity.this, Login_Activity.class));
                else
                    AppUtils.showDialogSignOut(Wallet_Transaction_Report_Shopping_Activity.this);
            }
        });
        ...
        try {
            ...
            btn_load_more.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    TopRows = TopRows + 25;
                    createWalletTransactionShoppingReportRequest();
            ...
            txt_from_date.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    new DatePickerDialog(Wallet_Transaction_Report_Shopping_Activity.this, date, myCalendar.get(Calendar.YEAR), myCalendar.get(Calendar.MONTH), myCalendar.get(Calendar.DAY_OF_MONTH)).show();
                }
            });
            ...
            txt_heading.setText("Shopping Wallet Transaction Detail");
    ...
    private void createWalletTransactionShoppingReportRequest() {
        ...
        executeWalletTransactionShoppingReportRequest(postParameters);
    }

    private void executeWalletTransactionShoppingReportRequest(final List postparameters) {
        try {
            if (AppUtils.isNetworkAvailable(Wallet_Transaction_Report_Shopping_Activity.this)) {
                new AsyncTask<Void, Void, String>() {
                    protected void onPreExecute() {
                        AppUtils.showProgressDialog(Wallet_Transaction_Report_Shopping_Activity.this);
                    }
                    ...
                    protected String doInBackground(Void... params) {
                        String response = "";
                        try {
                            response = AppUtils.callWebServiceWithMultiParam(Wallet_Transaction_Report_Shopping_Activity.this,postparameters, QueryUtils.methodToShoppingWalletTransactionDetail, TAG);
                        ...
                        try {
                            ...
                            if (jsonObject.getString("Status").equalsIgnoreCase("True")) {
                                if (jsonObject.getString("Message").equalsIgnoreCase("Successfully.!")) {
                                    ...
                                    AppUtils.alertDialog(Wallet_Transaction_Report_Shopping_Activity.this, jsonObject.getString("Message"));
                                }
                            } else {
                                AppUtils.alertDialog(Wallet_Transaction_Report_Shopping_Activity.this, jsonObject.getString("Message"));
                            }
                            ...
                            e.printStackTrace();
                            AppUtils.showExceptionDialog(Wallet_Transaction_Report_Shopping_Activity.this);
                        }
                    }
                ...
                new AsyncTask<Void, Void, String>() {
                    ...
                    protected String doInBackground(Void... params) {
                        ...
                        try {
                            List<NameValuePair> postParameters = new ArrayList<>();
                            postParameters.add(new BasicNameValuePair("Formno", AppController.getSpUserInfo().getString(SPUtils.USER_FORM_NUMBER, "")));
                            response = AppUtils.callWebServiceWithMultiParam(Wallet_Transaction_Report_Shopping_Activity.this,
                    ...
                    protected void onPostExecute(String resultData) {
                        try {
                            ...
                            if (jsonObject.getString("Status").equalsIgnoreCase("True")) {
                                ...
                                if (jsonObject.getString("Message").equalsIgnoreCase("Successfully.!")) {
                                    String count_text = "(Shopping Wallet Balance " + jsonArrayData.getJSONObject(0).getString("WBalance") + " )";
