...
public class Single_Leg_Bonus_Activity extends AppCompatActivity {

    String TAG = "Monthly_Incentive_Activity";
        ...
        img_login_logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!AppController.getSpIsLogin().getBoolean(SPUtils.IS_LOGIN, false))
                    startActivity(new Intent(Single_Leg_Bonus_Activity.this, Login_Activity.class));
                else
                    AppUtils.showDialogSignOut(Single_Leg_Bonus_Activity.this);
            }
        });
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
         ...
         //   AppUtils.setActionbarTitle(getSupportActionBar(), this);
            ...
            textView.setText("Single Leg Bonus Detail ");
    ...
    private void executeWeeklyIncentiveRequest() {
        try {
            if (AppUtils.isNetworkAvailable(Single_Leg_Bonus_Activity.this)) {
                new AsyncTask<Void, Void, String>() {
                    protected void onPreExecute() {
                        AppUtils.showProgressDialog(Single_Leg_Bonus_Activity.this);
                    }
                    ...
                    protected String doInBackground(Void... params) {
                        ...
                        try {
                            ...
                            response = AppUtils.callWebServiceWithMultiParam(Single_Leg_Bonus_Activity.this, postParameters, QueryUtils.methodToGetSingleLegBonus, TAG);
                    ...
                    protected void onPostExecute(String resultData) {
                        ...
                        try {
                            ...
                            if (jsonObject.getString("Status").equalsIgnoreCase("True")) {
                                ...
                                AppUtils.dismissProgressDialog();
                                AppUtils.alertDialog(Single_Leg_Bonus_Activity.this, jsonObject.getString("Message"));
                            }
                        } catch (Exception e) {
                            e.printStackTrace();
                            AppUtils.showExceptionDialog(Single_Leg_Bonus_Activity.this);
                        }
                    }
    ...
    public void WriteValues(JSONArray jsonArray) {
     ...
     /*   Payout No.	From Date	To Date	Down Team Active IDs Count	Achieved Level	Level 1 Income	Level 2 Income	Level 3 Income	Level 4 Income	Level 5 Income
     	Level 6 Income	Level 7 Income	Level 8 Income	Level 9 Income	Level 10 Income	Gross Incentive*/
        A1.setText("Payout No.");
        B1.setText("From\nDate");
        C1.setText("To\nDate");
        D1.setText("Down Team \nActive IDs Count");
        E1.setText("Achieved \nLevel");
        F1.setText("Level 1 \nIncome");
        G1.setText("Level 2 \nIncome");
        H1.setText("Level 3 \nIncome");
               ...
               /* int payout_number = jobject.getInt("PayoutNo");
                ...
                P.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent intent = new Intent(Single_Leg_Bonus_Activity.this, Weekly_Incentive_Statement_Activity.class);
