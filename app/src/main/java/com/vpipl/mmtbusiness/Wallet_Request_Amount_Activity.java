        ...
        expListView.setOnGroupClickListener(new ExpandableListView.OnGroupClickListener() {
            ...
            public boolean onGroupClick(ExpandableListView parent, View v, int groupPosition, long id) {
                ...
                if (GroupTitle.trim().equalsIgnoreCase(getResources().getString(R.string.dashboard))) {
                    startActivity(new Intent(Wallet_Request_Amount_Activity.this, DashBoard_New.class));
                    if (drawer.isDrawerOpen(GravityCompat.START)) {
                        drawer.closeDrawer(GravityCompat.START);
                    }
                } else if (GroupTitle.trim().equalsIgnoreCase("Home")) {
                    startActivity(new Intent(Wallet_Request_Amount_Activity.this, Home_Activity.class));
                    if (drawer.isDrawerOpen(GravityCompat.START)) {
                        drawer.closeDrawer(GravityCompat.START);
                    }
                } else if (GroupTitle.trim().equalsIgnoreCase("Logout")) {
                    AppUtils.showDialogSignOut(Wallet_Request_Amount_Activity.this);
                } else if (GroupTitle.trim().equalsIgnoreCase("Add New member")) {
                    //   startActivity(new Intent(Wallet_Request_Amount_Activity.this, Register_Activity.class));
                    Intent intent = new Intent(Wallet_Request_Amount_Activity.this, Register_Activity.class);
                    intent.putExtra("spo_id", "");
                    startActivity(intent);
                    if (drawer.isDrawerOpen(GravityCompat.START)) {
                        drawer.closeDrawer(GravityCompat.START);
                    }
        ...
        expListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                ...
                if (ChildItemTitle.trim().equalsIgnoreCase(getResources().getString(R.string.view_profile))) {
                    startActivity(new Intent(act, Profile_View_Activity.class));
                ...
                } else if (ChildItemTitle.trim().equalsIgnoreCase("My Sales Point History")) {
                    startActivity(new Intent(act, Repurchase_BV_Detail.class));
                } else if (ChildItemTitle.trim().equalsIgnoreCase("Dual Team Sales Point History")) {
                    startActivity(new Intent(act, Repurchase_BV_Summary_Team_Activity.class));
                } else if (ChildItemTitle.trim().equalsIgnoreCase("My Purchase Invoices")) {
                    ...
                    startActivity(new Intent(act, Monthly_Incentive_Activity.class));
                } else if (ChildItemTitle.trim().equalsIgnoreCase(getResources().getString(R.string.monthly_incentive_detail_report))) {
                    startActivity(new Intent(act, Monthly_Incentive_Detail_Activity.class));
                } else if (ChildItemTitle.trim().equalsIgnoreCase("TDS Detail Report")) {
                    startActivity(new Intent(act, TDS_detail_report_Activity.class));
                    ...
                    startActivity(new Intent(act, KYCUploadDocument_Activity.class).putExtra("HEADING", "View"));
                } else if (ChildItemTitle.trim().equalsIgnoreCase("Contact Support")) {
                    ...
                    startActivity(new Intent(act, ViewPendingQueries_Activity.class).putExtra("HEADING", "Open"));
                } else if (ChildItemTitle.trim().equalsIgnoreCase("View Closed Queries")) {
                    startActivity(new Intent(act, ViewPendingQueries_Activity.class).putExtra("HEADING", "Closed"));
                } else if (ChildItemTitle.trim().equalsIgnoreCase("Order History")) {
                    startActivity(new Intent(act, MyOrders_Activity.class));
                }else if (ChildItemTitle.trim().equalsIgnoreCase("Dual Team Members")) {
                    startActivity(new Intent(act, Downline_Team_Details_Activity.class));
                }else if (ChildItemTitle.trim().equalsIgnoreCase("Dual Team Structure")) {
                    startActivity(new Intent(act, Dual_Tree_Activity.class));
                }else if (ChildItemTitle.trim().equalsIgnoreCase("Dual Team Placement")) {
                    startActivity(new Intent(act, Dual_Team_Placement_Activity.class));
                }else if (ChildItemTitle.trim().equalsIgnoreCase("Banners")) {
                    startActivity(new Intent(act, Banners_Activity.class));
                }else if (ChildItemTitle.trim().equalsIgnoreCase("Business Card")) {
                    startActivity(new Intent(act, Business_card_Activity.class));
                }
