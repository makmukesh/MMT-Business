 ...
 */
public class Binary_genealogy_Activity extends AppCompatActivity {
        ...
        img_login_logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!AppController.getSpIsLogin().getBoolean(SPUtils.IS_LOGIN, false))
                    startActivity(new Intent(Binary_genealogy_Activity.this, Login_Activity.class));
                else
                    AppUtils.showDialogSignOut(Binary_genealogy_Activity.this);
            }
        });
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            txt_heading.setText("Binary Genealogy");
            ...
            webView_viewGenealogy.setWebViewClient(new WebViewClient() {
                public void onPageStarted(WebView view, String url, Bitmap favicon) {
                    AppUtils.showProgressDialog(Binary_genealogy_Activity.this);
                }
            ...
            if (AppUtils.isNetworkAvailable(Binary_genealogy_Activity.this)) {
                webView_viewGenealogy.loadUrl(QueryUtils.getViewBinarygenealogyURL(Binary_genealogy_Activity.this));
            } else {
                AppUtils.alertDialog(Binary_genealogy_Activity.this, getResources().getString(R.string.txt_networkAlert));
            }
        } catch (Exception e) {
            e.printStackTrace();
            AppUtils.showExceptionDialog(Binary_genealogy_Activity.this);
        }
