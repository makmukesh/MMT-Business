...
public class Weekly_Incentive_Activity extends AppCompatActivity {
        ...
        img_login_logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!AppController.getSpIsLogin().getBoolean(SPUtils.IS_LOGIN, false))
                    startActivity(new Intent(Weekly_Incentive_Activity.this, Login_Activity.class));
                else
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
         ...
         //   AppUtils.setActionbarTitle(getSupportActionBar(), this);
            ...
            textView.setText("Weekly Incentive");
    ...
    private void executeWeeklyIncentiveRequest() {
        try {
            if (AppUtils.isNetworkAvailable(Weekly_Incentive_Activity.this)) {
                new AsyncTask<Void, Void, String>() {
                    ...
                    protected String doInBackground(Void... params) {
                        ...
                        try {
                            ...
                            response = AppUtils.callWebServiceWithMultiParam(Weekly_Incentive_Activity.this, postParameters, QueryUtils.methodToGetWeeklyIncentiveDetail, TAG);
            ...
            try {
                ...
                P.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent intent = new Intent(Weekly_Incentive_Activity.this, Weekly_Incentive_Statement_Activity.class);
