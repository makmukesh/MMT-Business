...
public class Wallet_Withdrawal_Report_Activity extends AppCompatActivity {

    String TAG = "Wallet_Withdrawal_Report_Activity";
    ...
    private void showdatePicker() {
        ...
        datePickerDialog = new DatePickerDialog(Wallet_Withdrawal_Report_Activity.this, date, calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH), calendar.get(Calendar.DAY_OF_MONTH));
    ...
    final DatePickerDialog.OnDateSetListener date = new DatePickerDialog.OnDateSetListener() {
        ...
        public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
            ...
            if (new Date().after(myCalendar.getTime())) {
                ...
                AppUtils.alertDialog(Wallet_Withdrawal_Report_Activity.this, "Selected Date Can't be After today");
            }
        }
    };
        ...
        img_login_logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!AppController.getSpIsLogin().getBoolean(SPUtils.IS_LOGIN, false))
                    startActivity(new Intent(Wallet_Withdrawal_Report_Activity.this, Login_Activity.class));
                else
                    AppUtils.showDialogSignOut(Wallet_Withdrawal_Report_Activity.this);
            }
        });
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wallet_withdrawal_report);
    ...
    private void executeWalletTransactionReportRequest(final List postparameters) {
        try {
            if (AppUtils.isNetworkAvailable(Wallet_Withdrawal_Report_Activity.this)) {
                new AsyncTask<Void, Void, String>() {
                    protected void onPreExecute() {
                        AppUtils.showProgressDialog(Wallet_Withdrawal_Report_Activity.this);
                    }
                    ...
                    protected String doInBackground(Void... params) {
                        String response = "";
                        try {
                            response = AppUtils.callWebServiceWithMultiParam(Wallet_Withdrawal_Report_Activity.this,
                                    postparameters, QueryUtils.methodToWalletWithdrawalRequestReport, TAG);
                          ...
                          //  executeWalletBalanceRequest();
                            ...
                            if (jsonObject.getString("Status").equalsIgnoreCase("True")) {
                                if (jsonObject.getString("Message").equalsIgnoreCase("Successfully.!")) {
                                    ...
                                    AppUtils.alertDialog(Wallet_Withdrawal_Report_Activity.this, jsonObject.getString("Message"));
                                }
                            } else {
                                AppUtils.alertDialog(Wallet_Withdrawal_Report_Activity.this, jsonObject.getString("Message"));
                            }
                            ...
                            e.printStackTrace();
                            AppUtils.showExceptionDialog(Wallet_Withdrawal_Report_Activity.this);
                        }
                    }
    ...
    public void WriteValues(final JSONArray jarray) {
        ...
        B1.setText("Request Date/Time");
        C1.setText("Amount");
        D1.setText("Request Remarks");
        E1.setText("Request Status");
        F1.setText("Response Remarks");
        G1.setText("Paid Status");
        H1.setText("A/R Date/Time");
        ...
        for (int i = 0; i < jarray.length(); i++) {
            try {
                ...
                String RequestNo = jobject.getString("ReqNo");
                String RequestDateTime = jobject.getString("RqDtTime");
                RequestDateTime = AppUtils.getDateFromAPIDateTime(RequestDateTime);
                String Amount = jobject.getString("ReqAmount");
                String ReqRemarks = jobject.getString("ReqRemarks");
                String ReqStatus = jobject.getString("ReqStatus");
                String ResponseRemarks = jobject.getString("ResponseRemarks");
                String PaidStatus = jobject.getString("PaidStatus");
                String PaidDateTime = jobject.getString("PDDate");
                String TransactionNo = jobject.getString("TransactionNo");
                ...
                A.setText(RequestNo);
                B.setText(RequestDateTime);
                C.setText(Amount);
                D.setText(ReqRemarks);
                E.setText(ReqStatus);
                F.setText(ResponseRemarks);
                G.setText(PaidStatus);
                H.setText(PaidDateTime);
                I.setText(TransactionNo);
                J.setText(PayRemarks);
