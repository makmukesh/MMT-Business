...
public class Pin_details_for_receive_Activity extends AppCompatActivity {
        ...
        img_login_logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!AppController.getSpIsLogin().getBoolean(SPUtils.IS_LOGIN, false))
                    startActivity(new Intent(Pin_details_for_receive_Activity.this, Login_Activity.class));
                else
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (AppUtils.isNetworkAvailable(this)) {
            executePinReceiveReportDetails();
        } else {
    ...
    private void executePinReceiveReportDetails() {
                ...
                new AsyncTask<Void, Void, String>() {
                    ...
                    protected String doInBackground(Void... params) {
                        ...
                        try {
                            ...
                            response = AppUtils.callWebServiceWithMultiParam(Pin_details_for_receive_Activity.this, postParameters, QueryUtils.PinReceiveReportDetails, TAG);
