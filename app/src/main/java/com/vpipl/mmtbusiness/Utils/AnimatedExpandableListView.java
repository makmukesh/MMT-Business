...
public class AnimatedExpandableListView extends ExpandableListView {
     ...
     * instance for group expansion, we tell the adapter_shopping to animate the
     ...
     * ExpandableListView does this is by calling getView() in the adapter_shopping.
     * However since the adapter_shopping knows that we are animating a certain group,
     ...
     * adapter_shopping to stop animating the group and call notifyDataSetChanged. Now
     ...
     *
     * 1. The ExpandableListView tells the adapter_shopping to animate a certain group.
     ...
     * 5. Since the adapter_shopping is in "animating mode", it will return a dummy view.
     ...
     * 8. Once the animation completes, the adapter_shopping is notified to stop
     ...
     * 4. Since the adapter_shopping is in "animating mode", it will return a dummy view.
     ...
     * 7. Once the animation completes, the adapter_shopping is notified to stop
     *    animating the group and notifyDataSetChanged is called again.
    ...
    public void setAdapter(ExpandableListAdapter adapter) {
        ...
        // Make sure that the adapter_shopping extends AnimatedExpandableListAdapter
    ...
    public boolean expandGroupWithAnimation(int groupPos) {
        ...
        if (groupFlatPos != -1) {
            ...
            if (childIndex < getChildCount()) {
                ...
                if (v.getBottom() >= getBottom()) {
                    ...
                    // We need to notify the adapter_shopping that the group was expanded
        ...
        // Let the adapter_shopping know that we are starting the animation...
    ...
    public boolean collapseGroupWithAnimation(int groupPos) {
        ...
        // Let the adapter_shopping know that we are going to start animating the
        // collapse animation.
    ...
    /**
     * A specialized adapter_shopping for use with the AnimatedExpandableListView. All
