...
public class Bill_Gas_Activity extends AppCompatActivity {

    private static final String TAG = "Bill_Gas_Activity";

    private ArrayList<HashMap<String, String>> ServiceProviderList = new ArrayList<>();

    private Button btn_proceed;

    private String service_type = "GAS";
    ...
    private void showOperatorDialog() {
        try {
            ...
            builder.setTitle("Select Gas Provider");
            ...
            e.printStackTrace();
            AppUtils.showExceptionDialog(Bill_Gas_Activity.this);
        }
    }
    ...
    private void executeServiceProviderList(final String ServiceType) {
        new AsyncTask<Void, Void, String>() {
            protected void onPreExecute() {
                AppUtils.showProgressDialog(Bill_Gas_Activity.this);
            }
            ...
            protected String doInBackground(Void... params) {
                ...
                try {
                    ...
                    response = AppUtils.callWebServiceWithMultiParam(Bill_Gas_Activity.this, postParameters, QueryUtils.methodToGetServiceProviderList, TAG);
                ...
                try {
                    ...
                    if (jsonObject.getString("Status").equalsIgnoreCase("True")) {
                        ...
                        if (jsonArrayData.length() != 0) {
                            ...
                            AppUtils.alertDialog(Bill_Gas_Activity.this, jsonObject.getString("Message"));
                        }
                    } else {
                        AppUtils.alertDialog(Bill_Gas_Activity.this, jsonObject.getString("Message"));
                    }
    ...
    private void ValidateData() {
        ...
        if (TextUtils.isEmpty(operator)) {
            AppUtils.alertDialog(Bill_Gas_Activity.this, "Please Select Gas Provider");
        } else  if (TextUtils.isEmpty(mobile_number)) {
            AppUtils.alertDialog(Bill_Gas_Activity.this, "Please Enter Consumer Number");
        } else if (TextUtils.isEmpty(amount)) {
            AppUtils.alertDialog(Bill_Gas_Activity.this, "Please Enter Amount");
        } else if (Double.parseDouble(amount) <= 0) {
            AppUtils.alertDialog(Bill_Gas_Activity.this, "Please Enter Valid Amount");
        } else if (AWB < Double.parseDouble(amount)) {
            AppUtils.alertDialog(Bill_Gas_Activity.this, "Insufficient Wallet Balance");
        } else {
            if (AppUtils.isNetworkAvailable(Bill_Gas_Activity.this)) {
                showPaymentConfirmationDialog();
            } else {
                AppUtils.alertDialog(Bill_Gas_Activity.this, getResources().getString(R.string.txt_networkAlert));
            }
        }
    }
    ...
    public void showPaymentConfirmationDialog() {
        try {
            ...
            txt_DialogTitle.setText(Html.fromHtml("Are you confirm to Pay Your Gas Bill of " + edtxt_amount.getText().toString() + " through Wallet Amount. Please click on Confirm to proceed ahead."));
                ...
                new AsyncTask<Void, Void, String>() {
                    ...
                    protected String doInBackground(Void... params) {
                        ...
                        try {
                            List<NameValuePair> postParameters = new ArrayList<>();
                            postParameters.add(new BasicNameValuePair("FormNo", AppController.getSpUserInfo().getString(SPUtils.USER_FORM_NUMBER, "")));
                            response = AppUtils.callWebServiceWithMultiParam(Bill_Gas_Activity.this,
            ...
            if (AppUtils.isNetworkAvailable(Bill_Gas_Activity.this)) {
                new AsyncTask<Void, Void, String>() {
                    ...
                    protected String doInBackground(Void... params) {
                        String response = "";
                        try {
                            response = AppUtils.callWebServiceWithMultiParam(Bill_Gas_Activity.this, postParameters, QueryUtils.methodToDoRecharge, TAG);
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                        return response;
                    ...
                    protected void onPostExecute(String resultData) {
                        try {
                            ...
                            if (jsonObject.getString("Status").equalsIgnoreCase("True")) {
                                ...
                                Intent intent = new Intent(Bill_Gas_Activity.this, Bill_Success_Activity.class);
                                ...
                                Intent intent = new Intent(Bill_Gas_Activity.this, Bill_Failed_Activity.class);
                                intent.putExtra("OrderID", jsonObject1.getString("AGENTID"));
                                intent.putExtra("MobileNo", edtxt_mobileNumber.getText().toString());
                                intent.putExtra("amount", edtxt_amount.getText().toString());
                                intent.putExtra("operator", txt_operator.getText().toString());
