...
public class Monthly_Incentive_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
         ...
         //   AppUtils.setActionbarTitle(getSupportActionBar(), this);
            ...
            textView.setText("Monthly Incentive");
    ...
    public void WriteValues(JSONArray jsonArray) {
        ...
        // Month Name	From Date	To Date	Suhana Bonus	Super Bonus	Travel Fund         //Bonus	Gross        //Incentive	TDS        //Amount	Admin
        //Charge	Cheque        //Amount	Statement
      ...
      //  D1.setText("Suhana \nBonus");
       ...
       /* row1.addView(K1);
        row1.addView(L1);
        row1.addView(M1);        row1.addView(N1);
        row1.addView(O1);*/
        row1.addView(P1);
               ...
               /* int payout_number = jobject.getInt("PayoutNo");
                ...
                P.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent intent = new Intent(Monthly_Incentive_Activity.this, Weekly_Incentive_Statement_Activity.class);
