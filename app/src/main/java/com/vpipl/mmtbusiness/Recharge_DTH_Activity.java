...
public class Recharge_DTH_Activity extends AppCompatActivity {

    private static final String TAG = "Recharge_DTH_Activity";

    private ArrayList<HashMap<String, String>> ServiceProviderList = new ArrayList<>();

    private Button btn_proceed;

    private String service_type = "DTH";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recharge__dth);
    ...
    private void showOperatorDialog() {
        try {
            ...
            e.printStackTrace();
            AppUtils.showExceptionDialog(Recharge_DTH_Activity.this);
        }
    }
    ...
    private void executeServiceProviderList(final String ServiceType) {
        new AsyncTask<Void, Void, String>() {
            protected void onPreExecute() {
                AppUtils.showProgressDialog(Recharge_DTH_Activity.this);
            }
            ...
            protected String doInBackground(Void... params) {
                ...
                try {
                    ...
                    response = AppUtils.callWebServiceWithMultiParam(Recharge_DTH_Activity.this, postParameters, QueryUtils.methodToGetServiceProviderList, TAG);
                ...
                try {
                    ...
                    if (jsonObject.getString("Status").equalsIgnoreCase("True")) {
                        ...
                        if (jsonArrayData.length() != 0) {
                            ...
                            AppUtils.alertDialog(Recharge_DTH_Activity.this, jsonObject.getString("Message"));
                        }
                    } else {
                        AppUtils.alertDialog(Recharge_DTH_Activity.this, jsonObject.getString("Message"));
                    }
    ...
    private void ValidateData() {
        ...
        if (TextUtils.isEmpty(mobile_number)) {
            AppUtils.alertDialog(Recharge_DTH_Activity.this, getResources().getString(R.string.error_required_mobile_number));
//        } else if (mobile_number.trim().length() != 10) {
//            AppUtils.alertDialog(Recharge_DTH_Activity.this, getResources().getString(R.string.error_invalid_mobile_number));
        } else if (TextUtils.isEmpty(operator)) {
            AppUtils.alertDialog(Recharge_DTH_Activity.this, "Please Select Operator");
        } else if (TextUtils.isEmpty(amount)) {
            AppUtils.alertDialog(Recharge_DTH_Activity.this, "Please Enter Amount");
        } else if (Double.parseDouble(amount) <= 0) {
            AppUtils.alertDialog(Recharge_DTH_Activity.this, "Please Enter Valid Amount");
        } else if (AWB < Double.parseDouble(amount)) {
            AppUtils.alertDialog(Recharge_DTH_Activity.this, "Insufficient Wallet Balance");
        } else {
            if (AppUtils.isNetworkAvailable(Recharge_DTH_Activity.this)) {
                showPaymentConfirmationDialog();
            } else {
                AppUtils.alertDialog(Recharge_DTH_Activity.this, getResources().getString(R.string.txt_networkAlert));
            }
        }
    }
    ...
    public void showPaymentConfirmationDialog() {
        try {
            ...
            txt_DialogTitle.setText(Html.fromHtml("Are you confirm to perform DTH Recharge of " + edtxt_amount.getText().toString() + " through Wallet Amount. Please click on Confirm to proceed ahead."));
                ...
                new AsyncTask<Void, Void, String>() {
                    ...
                    protected String doInBackground(Void... params) {
                        ...
                        try {
                            List<NameValuePair> postParameters = new ArrayList<>();
                            postParameters.add(new BasicNameValuePair("FormNo", AppController.getSpUserInfo().getString(SPUtils.USER_FORM_NUMBER, "")));
                            response = AppUtils.callWebServiceWithMultiParam(Recharge_DTH_Activity.this,
            ...
            if (AppUtils.isNetworkAvailable(Recharge_DTH_Activity.this)) {
                new AsyncTask<Void, Void, String>() {
                    ...
                    protected String doInBackground(Void... params) {
                        ...
                        try {
                            response = AppUtils.callWebServiceWithMultiParam(Recharge_DTH_Activity.this,
                                    postParameters, QueryUtils.methodToDoRecharge, TAG);
                    ...
                    protected void onPostExecute(String resultData) {
                        try {
                            ...
                            if (jsonObject.getString("Status").equalsIgnoreCase("True")) {
                                ...
                                Intent intent = new Intent(Recharge_DTH_Activity.this, Recharge_Mobile_Success_Activity.class);
                                ...
                                Intent intent = new Intent(Recharge_DTH_Activity.this, Recharge_Mobile_Failed_Activity.class);
                                intent.putExtra("OrderID", jsonObject1.getString("AGENTID"));
                                intent.putExtra("MobileNo", edtxt_mobileNumber.getText().toString());
                                intent.putExtra("amount", edtxt_amount.getText().toString());
                                intent.putExtra("operator", txt_operator.getText().toString());
