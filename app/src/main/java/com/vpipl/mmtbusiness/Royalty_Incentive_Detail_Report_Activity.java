...
public class Royalty_Incentive_Detail_Report_Activity extends AppCompatActivity {

    public ArrayList<HashMap<String, String>> SessionList = new ArrayList<>();

    String TAG = "Royalty_Incentive_Detail_Report_Activity";
        ...
        img_login_logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!AppController.getSpIsLogin().getBoolean(SPUtils.IS_LOGIN, false))
                    startActivity(new Intent(Royalty_Incentive_Detail_Report_Activity.this, Login_Activity.class));
                else
                    AppUtils.showDialogSignOut(Royalty_Incentive_Detail_Report_Activity.this);
            }
        });
    ...
    private void executePackageRequest()
    {
        new AsyncTask<Void, Void, String>() {
            protected void onPreExecute() {
                AppUtils.showProgressDialog(Royalty_Incentive_Detail_Report_Activity.this);
            }
            ...
            protected String doInBackground(Void... params) {
                ...
                response = AppUtils.callWebServiceWithMultiParam(Royalty_Incentive_Detail_Report_Activity.this, postParameters, QueryUtils.methodWeeklySession, TAG);
                return response;
            }
    ...
    private void showPackageDialog() {
        try {
            ...
            e.printStackTrace();
            AppUtils.showExceptionDialog(Royalty_Incentive_Detail_Report_Activity.this);
        }
    }
    ...
    private void createLevelCommissionRequest() {
        ...
        List<NameValuePair> postParameters = new ArrayList<>();
        postParameters.add(new BasicNameValuePair("MemberID", AppController.getSpUserInfo().getString(SPUtils.USER_ID_NUMBER, "")));
        postParameters.add(new BasicNameValuePair("SessidID", "" + packageid));
    ...
    private void executeLevelCommissionRequest(final List postparameters) {
        try {
            if (AppUtils.isNetworkAvailable(Royalty_Incentive_Detail_Report_Activity.this)) {
                new AsyncTask<Void, Void, String>() {
                    protected void onPreExecute() {
                        AppUtils.showProgressDialog(Royalty_Incentive_Detail_Report_Activity.this);
                    }
                    ...
                    protected String doInBackground(Void... params) {
                        ...
                        try {
                            ...
                            response = AppUtils.callWebServiceWithMultiParam(Royalty_Incentive_Detail_Report_Activity.this, postparameters, QueryUtils.methodRoyaltyIncentiveDetailReport, TAG);
                    ...
                    protected void onPostExecute(String resultData) {
                        ...
                        try {
                            ...
                            if (jsonObject.getString("Status").equalsIgnoreCase("True"))
                            {
                                ...
                                AppUtils.alertDialog(Royalty_Incentive_Detail_Report_Activity.this, jsonObject.getString("Message"));
                            }
                        } catch (Exception e) {
                            e.printStackTrace();
                            AppUtils.showExceptionDialog(Royalty_Incentive_Detail_Report_Activity.this);
