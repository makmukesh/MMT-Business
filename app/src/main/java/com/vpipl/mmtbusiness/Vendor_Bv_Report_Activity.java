...
public class Vendor_Bv_Report_Activity extends AppCompatActivity {

    public ArrayList<HashMap<String, String>> FranchiseeList = new ArrayList<>();

    String TAG = "Vendor_Bv_Report_Activity";
    ...
    final DatePickerDialog.OnDateSetListener date = new DatePickerDialog.OnDateSetListener() {
        ...
        public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
            ...
            if (new Date().after(myCalendar.getTime())) {
                ...
                AppUtils.alertDialog(Vendor_Bv_Report_Activity.this, "Selected Date Can't be After today");
            }
        }
    };
        ...
        img_login_logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!AppController.getSpIsLogin().getBoolean(SPUtils.IS_LOGIN, false))
                    startActivity(new Intent(Vendor_Bv_Report_Activity.this, Login_Activity.class));
                else
                    AppUtils.showDialogSignOut(Vendor_Bv_Report_Activity.this);
            }
        });
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vendor_bv_report);
...
//            btn_load_more.setVisibility(View.GONE);
            ...
            txt_ttl_bv =  findViewById(R.id.txt_ttl_bv);
            ...
            txt_fromdate.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    new DatePickerDialog(Vendor_Bv_Report_Activity.this, date, myCalendar.get(Calendar.YEAR), myCalendar.get(Calendar.MONTH), myCalendar.get(Calendar.DAY_OF_MONTH)).show();
                }
            });
    ...
    private void executeFranchiseeListRequest() {
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... params) {
                ...
                response = AppUtils.callWebServiceWithMultiParam(Vendor_Bv_Report_Activity.this, postParameters, QueryUtils.methodSponsorVendorBVReport, TAG);
                return response;
            }
    ...
    private void showFranchiseeDialog() {
        try {
            ...
            e.printStackTrace();
            AppUtils.showExceptionDialog(Vendor_Bv_Report_Activity.this);
        }
    }
...
//        findViewById(R.id.HSV).setVisibility(View.GONE);
        ...
        List<NameValuePair> postParameters = new ArrayList<>();
      //  postParameters.add(new BasicNameValuePair("FormNo", "1000001"));
    ...
    private void executeMemberDownlineListRequest(final List postparameters) {
        try {
            if (AppUtils.isNetworkAvailable(Vendor_Bv_Report_Activity.this)) {
                new AsyncTask<Void, Void, String>() {
                    protected void onPreExecute() {
                        AppUtils.showProgressDialog(Vendor_Bv_Report_Activity.this);
                    }
                    ...
                    protected void onPostExecute(String resultData) {
                        ...
                        try {
                            ...
                            if (jsonObject.getString("Status").equalsIgnoreCase("True")) {
                                ...
                                JSONArray jsonArrayTotalBV = jsonObject.getJSONArray("Total");

                                WriteValues(jsonArrayData , jsonArrayTotalBV);

                            } else {
                                AppUtils.alertDialog(Vendor_Bv_Report_Activity.this, jsonObject.getString("Message"));
                            }
                        } catch (Exception e) {
                            e.printStackTrace();
                            AppUtils.showExceptionDialog(Vendor_Bv_Report_Activity.this);
    ...
    public void WriteValues(JSONArray jsonArrayDownLineDetail ,JSONArray jsonArrayTotalBV) {
        findViewById(R.id.ll_showData).setVisibility(View.VISIBLE);

        try {

            if(jsonArrayTotalBV.length() > 0 ){
                txt_ttl_bv.setText("Total BV : "  + jsonArrayTotalBV.getJSONObject(0).getString("TotalBV"));
            }
...
//                    button_load_less.setVisibility(View.VISIBLE);
                ...
                A1.setText("Bill Date");
                B1.setText("Repurch Income");
                C1.setText("Order Date");
                D1.setText("Remarks");
                E1.setText("Amount");
                F1.setText("Approval Date");
                G1.setText("Status");
...
//                row1.addView(F1);
                ...
                for (int i = 0; i < jsonArrayDownLineDetail.length(); i++) {
                    try {
                        ...
                        String RepurchIncome = WordUtils.capitalizeFully(jobject.getString("RepurchIncome"));
                        String BillDate = AppUtils.getDateFromAPIDate(jobject.getString("BillDate"));
                        String OrderDt = AppUtils.getDateFromAPIDate(jobject.getString("OrderDt"));
